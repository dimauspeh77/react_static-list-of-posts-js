...
expedita consequatur consequatur dolores quia eos et placeat`}],tm=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Nc=({user:e})=>B.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Pc=({comment:e})=>B.jsxs("div",{className:"CommentInfo",children:[B.jsxs("div",{className:"CommentInfo__title",children:[B.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",B.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),B.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Lc=({comments:e})=>B.jsx("div",{className:"CommentList",children:e.map(t=>B.jsx(Pc,{comment:t},t.id))}),Tc=({post:e})=>B.jsxs("div",{className:"PostInfo",children:[B.jsxs("div",{className:"PostInfo__header",children:[B.jsx("h3",{className:"PostInfo__title",children:e.title}),B.jsxs("p",{children:[" Posted by  ",B.jsx(Nc,{user:e.user})]})]}),B.jsx("p",{className:"PostInfo__body",children:e.body}),e.comments.length===0?B.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"}):B.jsx(Lc,{comments:e.comments})]}),Mc=({posts:e})=>B.jsx("div",{className:"PostList",children:e.map(t=>B.jsx(Tc,{post:t},t.id))}),Rc=[{postId:1,id:1,name:"id labore ex et quam laborum",email:"Eliseo@gardner.biz",body:`laudantium enim quasi est quidem magnam voluptate ipsam eos
...
aut aut aut maxime quia temporibus ut omnis`}];function Dc(e){return tm.find(t=>t.id===e)||null}const jc=(e,t)=>e.filter(i=>i.postId===t.id),Oc=zc.map(e=>({...e,user:Dc(e.userId),comments:jc(Rc,e)})),Fc=()=>B.jsxs("section",{className:"App",children:[B.jsx("h1",{className:"App__title",children:"Static list of posts"}),B.jsx(Mc,{usersFromServer:tm,posts:Oc})]});em(document.getElementById("root")).render(B.jsx(Fc,{}));
